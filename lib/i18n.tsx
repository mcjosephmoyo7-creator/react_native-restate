...
const en = {
  ...
  bookings_cancelledBody:
    "{property} has been moved to your cancelled bookings.",
...
const translations: Record<string, Partial<Record<TranslationKey, string>>> = {
  ...
  explore_found: "Encontradas {count} Propiedades",
    ...
    bookings_cancelledBody:
      "{property} se ha movido a tus reservas canceladas.",
  ...
  explore_found: "{count} biens trouvés",
    ...
    bookings_cancelledBody:
      "{property} a été déplacée vers vos réservations annulées.",
  ...
  explore_found: "{count} Immobilien gefunden",
    ...
    bookings_cancelledBody:
      "{property} wurde zu Ihren stornierten Buchungen verschoben.",
  ...
  explore_found: "تم العثور على {count} عقارات",
    ...
    bookings_cancelledBody:
      "تم نقل {property} إلى حجوزاتك الملغاة.",
